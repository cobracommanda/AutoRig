...
#         self.create_temporary_group_representation()
...
#         control_pos = cmds.xform(self.objects_to_group[len(self.objects_to_group)-1], q=1, ws=1, t=1)
...
class GroupUI(QtWidgets.QDialog):
    ...
    def create_connections(self):
        ...
        self.ok_btn.clicked.connect(self.accept)
        self.lineedit.editingFinished.connect(self.on_editing_finished)
        self.position_last_selected_btn.clicked.connect(self.position_last_selected)
        self.position_average_position_btn.clicked.connect(self.position_average_position)
