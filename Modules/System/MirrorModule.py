...
#     # a module_info entry = (original_module, mirrored_module_name, mirror_plane, rotation_function, translation_function)
#         self.module_info = []
...
#             mirror_module_user_specified_name = cmds.textField(self.UI_elements[f'module_name_{original_module_name}'], q=1, tx=1)
...
#                 cmds.confirmDialog(t="Name Conflict", message=f"Name : {mirror_module_user_specified_name} already exist, aborting mirror", b=["Accept"], db="Accept")
#                 return
